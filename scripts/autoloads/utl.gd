...
# Enums
enum GRID {ROCK, ORGANELLE, ENERGY}
enum ROCK {NONE=-1, ROCK, COAL, IRON, COPPER, RADICAL}
enum DIRECTION {NONE, N, E, S, W, NW, SW, SE, NE, INV}
enum ENERGY {NONE = -1, WIRE}
enum ORGANELLE {NONE = -1, CENTRAL_UNIT, DRILL}
enum INTERACTION {NONE, REMOVE}

var energy_organelles = [ORGANELLE.CENTRAL_UNIT, ORGANELLE.DRILL]
